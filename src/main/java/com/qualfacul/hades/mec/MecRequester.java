...
public class MecRequester {
	...
	private static final String ADVANCED_SEARCH_PAGE = "/emec/nova-index/listar-consulta-avancada/list/2500";
	...
	public String requesCourseAdresses(String courseMecId, Integer... page){
		String url = "";
		if(page.length == 0) {
			url = COURSE_ADDRESS_PAGE + "/" + COURSE_HASH + "/" + encode(courseMecId) + "/list/10000";
		} else {
			url = COURSE_ADDRESS_PAGE + "/" + COURSE_HASH + "/" + encode(courseMecId) + "/page/" + page;			
		}
